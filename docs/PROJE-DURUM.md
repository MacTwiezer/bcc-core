...
| # | İş | Not |
|---|---|---|
| 1 | Kaydedilebilir görünümler (çoklu view) | Tek view'ın sort/filter/group/hidden/row height state'ini kaydetme TAMAM — bkz. Biten İşler. Sol panel artık kalıcı/daraltılabilir (bkz. Biten İşler) ama İÇERİĞİ hâlâ dekoratif. Kalan: her tabloda hâlâ TEK varsayılan satır var (`bcc_get_or_create_default_view`); birden fazla adlandırılmış görünüm oluşturma/arasında geçiş ("+ Create new..." hâlâ dekoratif, "Find a view" filtrelemiyor, `view_id` URL routing'i yok) |
