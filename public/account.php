...
<div class="sp-page ac-page">
        ...
        <div class="account-card account-card-profile">
            <div class="ac-profile-head">
                <?php $hasAvatar = bcc_avatar_url($user['id']) !== null; ?>
                <div class="ac-avatar" data-avatar-root data-initial="<?php echo htmlspecialchars(bcc_user_initial($user), ENT_QUOTES, 'UTF-8'); ?>">
                    <button type="button" class="account-avatar-lg ac-avatar-btn" data-avatar-pick aria-label="Profil fotoğrafını değiştir">
                        <span class="ac-avatar-face" data-avatar-view><?php echo bcc_avatar_inner_html($user); ?></span>
                        <span class="ac-avatar-cam" aria-hidden="true">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z"/><circle cx="12" cy="13" r="3.5"/></svg>
                        </span>
                    </button>
                    <input type="file" accept="image/png,image/jpeg,image/webp" data-avatar-input hidden>
                    <button type="button" class="ac-avatar-remove" data-avatar-remove<?php echo $hasAvatar ? '' : ' hidden'; ?>>Kaldır</button>
                </div>
                <div class="ac-profile-id">
                    ...
                    <p class="ac-avatar-status" data-avatar-status role="status" hidden></p>
                </div>
            </div>
